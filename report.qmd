...
Bellabeat is a successful high-tech manufacturer of health-focused products for women. The company has the potential to bevome a bigger player in the global smart device market. Additionally, Urška Sršen, cofounder and Chief Creative Officer of Bellabeat, believe that analyzing smart device fitness data could help unlock new growth opportunities for the company.
...
The aim of this analysis is to analyse smart device usage data in order to gain insight into how consumers use non-Bellabeat smart devices. I will be focusing on how much activity the users undertake. This will allow me advuce the company on its marketing strategy
